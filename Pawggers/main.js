...
function bigBoy(){
    if ("0-10" && "10-20"|| "20-30" && "10-20"||"0-10" && "20-30" in userMessage){
        console.log("Please only Select one Option.")
    }
    if ("MALE" && "FEMALE" in userMessage){
        console.log("Please only Select one Option.")
    }
    if ("small" && "medium"|| "small" && "large"||"medium" && "large" in userMessage){
        console.log("Please only Select one Option.")
    }
    if ("LOW" && "MEDIUM"|| "LOW" && "HIGH"||"MEDIUM" && "HIGH" in userMessage){
        console.log("Please only Select one Option.")
    }
